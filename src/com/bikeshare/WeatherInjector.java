...
public class WeatherInjector {
	...
	public static void main(String[] args) {
		...
		File folder = new File("E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithOutgoingBikes//DailyData");
	...
	private static void appendWeatherRecord(String stationID, List processedWeatherData) throws FileNotFoundException {
		// TODO Auto-generated method stub
		String csvFile = "E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithOutgoingBikes//DailyData//" + stationID + ".csv";
		BufferedReader br = null;
		String line = "";
		String cvsSplitBy = ",";

		PrintWriter writer = new PrintWriter(
				"E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithOutgoingBikes//DailyData//ProcessedWithWeather//" + stationID + ".csv");
		writer.append(
				"station_id,year,month,day,day_of_week,weekday,weekend,feelsLike,humid,visibility,wind,cloudcover,outgoing_bikes");
		writer.append("\n");
