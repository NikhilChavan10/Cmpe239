...
public class DailySalesCalculatorForIncomingBikes {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		File folder = new File("E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithIncomingBikes");
	...
	public static void dailySalesCalculator(File tempFile) {
		...
		try {
			...
			String newPath = "E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithIncomingBikes//DailyData//" + stationName;
			PrintWriter writer = new PrintWriter(newPath);
			writer.append("station_id,year,month,day,day_of_week,weekday,weekend,incoming_bikes");
			writer.append("\n");
			...
			while ((line = br.readLine()) != null) {
				...
				if (current_day != previous_day && previous_day != 0) {
					writer.append(previousRow[0] + "," + previousRow[1] + "," + previousRow[2] + "," + previousRow[3]
							+ "," + previousRow[6] + "," + previousRow[7]
							+ "," + previousRow[8] + "," + dailySalesCount);
					writer.append("\n");
					dailySalesCount = 0;
				}

				dailySalesCount = dailySalesCount + Integer.parseInt(hourlyRecord[9]);
