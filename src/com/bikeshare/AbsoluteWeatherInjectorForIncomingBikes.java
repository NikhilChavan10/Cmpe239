...
public class AbsoluteWeatherInjectorForIncomingBikes {
	...
	private static void injectWeatherData(String stationID, String zipCode) {
		...
		String csvFile = "E://MS SE//Fall 2015//CMPE 239//Project//201508_absolute_processed_weather_data.csv";
	...
	private static void appendWeatherRecord(String stationID, List processedWeatherData) throws FileNotFoundException {
		// TODO Auto-generated method stub
		String csvFile = "E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithIncomingBikes//DailyData//"
				+ stationID + ".csv";
		BufferedReader br = null;
		String line = "";
		String cvsSplitBy = ",";
		...
		PrintWriter writer = new PrintWriter(
				"E://MS SE//Fall 2015//CMPE 239//Project//StationDataWithIncomingBikes//DailyData//ProcessedWithAbsoluteWeather//"
						+ stationID + ".csv");
		writer.append(
			...
			while ((line = br.readLine()) != null) {
				...
				for (int i = 0; i < processedWeatherData.size(); i++) {
					...
					if (dailyRecord[1].equals(processed[1]) && dailyRecord[2].equals(processed[2])
						...
						System.out.println(processed[0] + processed[1] + processed[2] + processed[3] + processed[4]
						...
						writer.append(dailyRecord[0] + "," + dailyRecord[1] + "," + dailyRecord[2] + ","
								...
								+ "," + Integer.parseInt(processed[4]) + "," + Integer.parseInt(processed[5]) + ","
								+ Integer.parseInt(processed[6]) + "," + Integer.parseInt(processed[7]) + ","
								+ Integer.parseInt(processed[8]) + "," + dailyRecord[7]);
						writer.append("\n");
					}
				}
				writer.flush();
